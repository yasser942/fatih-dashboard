...
import { taskTypesColumns as columns } from './task-types-columns'
...
export function TaskTypesTable({ data, paginationInfo, loading, error }: DataTableProps) {
    // Local UI-only states
    const [rowSelection, setRowSelection] = useState({})
    const [sorting, setSorting] = useState<SortingState>([])
    const [columnVisibility, setColumnVisibility] = useState<VisibilityState>({})

    // Get task types context for edit functionality
    ...
    return (
        <div className="space-y-4">
            <DataTableToolbar table={table} filterKey="task_ar" filterPlaceholder="البحث في أنواع المهام..." />
                            ...
                            <TableRow>
                                <TableCell colSpan={columns.length} className="h-32 text-center">
                                    <div className="flex flex-col items-center justify-center gap-3">
                                        ...
                                        <div className="space-y-1">
                                            <p className="font-medium">لم يتم العثور على أنواع مهام</p>
